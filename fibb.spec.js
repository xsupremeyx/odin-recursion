...
describe('fibbonacci', () => {
  it('should return the correct fibbonacci number for a given input', () => {
  ...
  it('should handle negative input by returning null', () => {
    expect(fibbonacci(-1)).toBeNull();
    expect(fibbonacci(-5)).toBeNull();
  });

  it('should handle non-integer input by returning null', () => {
